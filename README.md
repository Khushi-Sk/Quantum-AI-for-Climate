...
All necessary code files and any additional information required to judge your project solution should be included in the repository.<br/>(This was too big to cover in slides)  [Firebench info](https://sites.research.google/wildfires/firebench/)<br/>  [Google Research Firebench](https://github.com/google-research/firebench/blob/main/examples/colab/Firebench_Browser.ipynb)<br/>  [FireBench](https://github.com/google-research/firebench/blob/main/examples/beam/compute_stats_test.py) <br/> [Firebench Dataset](https://console.cloud.google.com/storage/browser/firebench/v2024.04;tab=objects?prefix=&forceOnObjectsSortingFiltering=false)  
